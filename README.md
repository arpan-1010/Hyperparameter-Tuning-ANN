...
This repository implements an Artificial Neural Network (ANN) using **PyTorch** and performs hyperparameter tuning with **Optuna** on the **Fashion MNIST dataset**.
...
- Visualization of sample dataset images
